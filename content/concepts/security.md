...
## Overview 
Portworx security centers around the ubiquitous JWT based authentication and authorization model. This technology provides a proven secure model for user and account identification, and most major internet systems are using it.
...
Once Portworx has authenticated and authorized the user, it can then use the username and group information available in the claim to determine if the user has access to a specific resource.
